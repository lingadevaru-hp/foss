...
![FOSS logo](https://ipfs.io/ipfs/QmZjM3DiAsnwzVPBD2zNzDN518fJqTCmmw41u2bfRZFJMf)
...
- Logo URL: <https://ipfs.io/ipfs/QmZjM3DiAsnwzVPBD2zNzDN518fJqTCmmw41u2bfRZFJMf>
- Local logo file: [foss-logo.png](/home/libre/Documents/fossproject/foss-logo.png)
...
- `data/`:
  This holds the machine-readable token spec.
- `raw/`:
  This keeps the JSON, HTML, metadata, and source captures used during verification.
