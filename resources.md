...
- <https://explorer.solana.com/address/HLwsSkx8v7z25N6aZo6rjAywJ1YfjjwhpCA7fCD1Db2b>  
  Solana Explorer view of the creator and fee payer wallet used throughout the project documentation.
- <https://solscan.io/account/HLwsSkx8v7z25N6aZo6rjAywJ1YfjjwhpCA7fCD1Db2b>  
  Solscan view of the same wallet with transaction history.

## Orca Pool

- <https://www.orca.so/pools/3Ub4ojhVSiMZtmrS8bHSEiMo9oqzauTyYtd3HjFbZnE2>  
  Orca Whirlpool page for the FOSS / SOL trading pair.
- <https://explorer.solana.com/address/3Ub4ojhVSiMZtmrS8bHSEiMo9oqzauTyYtd3HjFbZnE2>  
  Solana Explorer page for the pool account.
- <https://docs.orca.so/developers/whirlpools/interacting-with-the-protocol>  
  Orca developer documentation for Whirlpools.

## GeckoTerminal

- <https://www.geckoterminal.com/solana/pools/3Ub4ojhVSiMZtmrS8bHSEiMo9oqzauTyYtd3HjFbZnE2>  
  GeckoTerminal chart and analytics page for the FOSS / SOL pool.
- <https://api.geckoterminal.com/api/v2/networks/solana/tokens/64AcKtFgExrtJWPJVr6U4iQrJ1VpiUvDHvRtdMHAcoin>  
  GeckoTerminal token API endpoint for FOSS.
- <https://api.geckoterminal.com/api/v2/networks/solana/pools/3Ub4ojhVSiMZtmrS8bHSEiMo9oqzauTyYtd3HjFbZnE2>  
  GeckoTerminal pool API endpoint for the Orca pool.

## IPFS Metadata

- <https://ipfs.io/ipfs/QmNaaTSFFy4ZBp95vhA8F8MCoYHu9tmzWgcW16YyQcni9n>  
  The IPFS metadata JSON. It contains the token name, symbol, description, and image URI.
- <https://ipfs.io/ipfs/QmZjM3DiAsnwzVPBD2zNzDN518fJqTCmmw41u2bfRZFJMf>  
  The IPFS-hosted token logo image.

## API Endpoints

- <https://api.mainnet-beta.solana.com>  
  Solana public JSON-RPC endpoint used for `getAccountInfo`, `getSignaturesForAddress`, and `getTokenLargestAccounts` verification.

## Program Addresses

- <https://explorer.solana.com/address/HtKnLjomtPrjJwyuQe6HApuEcnb76AUp3oG3nTpnQSAr>  
  Explorer page for the custom launchpad program used in this project.
- <https://solana.fm/address/HtKnLjomtPrjJwyuQe6HApuEcnb76AUp3oG3nTpnQSAr>  
  Solana FM page for the same launchpad program.
